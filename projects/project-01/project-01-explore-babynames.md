...
tbl_names_popular |> 
  ...
  labs(
    title = 'Popular Baby Names Bar Chart',
    subtitle = 'Years: 2011 to 2020',
    caption = 'Source: SSA',
    x = '# of births',
    y = 'Name'
  ) +
...
plot_trends_in_letter <- function(my_letter) {
  tbl_names_by_letter |> 
    ...
    labs(
      ...
      subtitle = glue::glue("Percentage of Births beginning with {my_letter}"),
      caption = "Source: SSA",
      x = "Year",
      y = "Percentage of Births"
    ) +
...
tbl_names_by_first_and_last_letter |> 
 ...
 labs(
   title = "Distribution of Percentage of Births by Last and First Letters of Names",
   subtitle = "Year: 2021",
   x = "First Letter",
   y = "Last Letter",
...
tbl_names_vowel_consonant |> 
  ...
  facet_wrap(~ sex, scales = "free_y") +
  # Add labels (title, subtitle, caption, x, y)
  labs(title = "Trends in Vowels and Consonants Used in Names over Time",
    subtitle = "",
    caption = "This visualization shows the percentage of births by the combination of first and last letter types by sex",
    x = "Year",
